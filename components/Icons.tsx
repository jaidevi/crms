...
export const ItemsIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const QuotesIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 17.5V5a2 2 0 0 1 2-2h11.5a2 2 0 0 1 2 2v12.5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z" />
    <path d="M8 12h8" />
    <path d="M8 8h8" />
    <path d="M8 16h4" />
  </svg>
...
export const DeliveryIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M14 9h4l4 4v4h-8v-4l4-4Z" />
    <circle cx="7" cy="18" r="2" />
    <circle cx="17" cy="18" r="2" />
  </svg>
);

export const InvoicesIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M8.5 10a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5" />
        <path d="M8.5 13a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5" />
        <path d="M12.5 16a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5" />
        <path d="M15 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9.5L15 4Z" />
...
export const CreditNotesIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M15 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9.5L15 4Z" />
    <path d="M14 3.5V9h5.5" />
    <path d="M12 18v-6" />
...
export const ExpensesIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M15 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9.5L15 4Z" />
    <path d="M14 3.5V9h5.5" />
...
export const FabricIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M20.56 14.33a3.31 3.31 0 0 0-2.87-2.06 3.31 3.31 0 0 0-2.87 2.06A3.31 3.31 0 0 0 12 16.39a3.31 3.31 0 0 0-2.82-2.06 3.31 3.31 0 0 0-2.88 2.06A3.31 3.31 0 0 0 3.44 16.5a3.31 3.31 0 0 0 0 2.12 3.31 3.31 0 0 0 2.88 2.06 3.31 3.31 0 0 0 2.87-2.06 3.31 3.31 0 0 0 2.82 2.06 3.31 3.31 0 0 0 2.82-2.06 3.31 3.31 0 0 0 2.87 2.06 3.31 3.31 0 0 0 2.87-2.06 3.31 3.31 0 0 0 0-2.12Z"/>
        <path d="m3.44 14.28 17.12-5.7"/>
        <path d="m3.44 9.56 17.12-5.7"/>
        <path d="m3.44 4.84 17.12-5.7"/>
    </svg>
);
...
export const WidthIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 12H3"/><path d="m18 9-3-3-3 3"/>
        <path d="m6 9 3-3 3 3"/>
        <path d="M18 15h3"/>
        <path d="M3 15h3"/>
        <path d="M12 21V3"/>
...
export const FlashIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M13 3l-10 11h9l-1 7 10-11h-9l1-7z"/>
  </svg>
);
...
export const WalletIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M18 12a2 2 0 0 0-2 2h-2a2 2 0 0 0 0 4h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2"/>
  </svg>
);
