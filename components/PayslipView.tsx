...
import type { Employee, CompanyDetails, Payslip } from '../App';
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6 no-print">
                <h1 className="text-xl font-semibold text-gray-800">Payslip Preview</h1>
                <div className="flex items-center gap-2">
                    ...
                    {onFinalizeSalary && (
                        <button onClick={handleFinalize} className="px-4 py-2 bg-green-600 text-white rounded-md text-sm font-semibold hover:bg-green-700">
                            Finalize Salary
                        </button>
                    )}
            ...
            <div id="printable-payslip" className="max-w-4xl mx-auto bg-white p-8 text-sm font-sans text-gray-800 border">
                <header className="text-center border-b pb-4">
                    <h2 className="text-2xl font-bold">{companyDetails.name}</h2>
                    <p className="text-gray-600">{companyDetails.addressLine1}, {companyDetails.addressLine2}</p>
