                ...
                <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl animate-fade-in-down overflow-hidden">
                    ...
                    <div className="p-6 space-y-8 max-h-[60vh] overflow-y-auto">
                        <fieldset className="border border-gray-200 rounded-lg p-4">
                            <legend className="text-base font-semibold text-gray-900 px-2">Order Details</legend>
                        ...
                        <fieldset className="border border-gray-200 rounded-lg p-4">
                            <legend className="text-base font-semibold text-gray-900 px-2">Payment Information</legend>
                            ...
                            {paymentMode === 'Cheque' && (
                                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-50 rounded-md border border-gray-200 mt-6">
                                    <div>
                        ...
                        <fieldset className="border border-gray-200 rounded-lg p-4">
                            <legend className="text-base font-semibold text-gray-900 px-2">Items <span className="text-red-500">*</span></legend>
