                            ...
                            <div className="text-sm text-gray-600 mt-1 flex items-center justify-end">
                                ...
                                <div className="relative w-32 no-print">
                                    <button 
                                        ...
                                        className="text-gray-900 font-semibold border-b border-gray-300 hover:border-blue-500 focus:outline-none w-full text-right"
                                    >
                                ...
                                <span className="font-semibold text-gray-900 hidden print:block hidden">{formatDateForDisplay(invoiceDate)}</span>
                                <span className="font-semibold text-gray-900 hidden print:block">{formatDateForDisplay(invoiceDate)}</span>
                            </div>
